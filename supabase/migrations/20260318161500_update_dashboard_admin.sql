-- New function with a different name to bypass any stubborn PostgREST schema cache issues

CREATE OR REPLACE FUNCTION public.update_dashboard_admin(
  target_auth_id UUID,
  new_email TEXT,
...
GRANT EXECUTE ON FUNCTION public.update_dashboard_admin(UUID, TEXT, TEXT, TEXT, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.update_dashboard_admin(UUID, TEXT, TEXT, TEXT, TEXT) TO service_role;
